...
public class SearchStaff {
    ...
    By ExitBranch = By.xpath("//button[.//span[@class=\"p-multiselect-close-icon pi pi-times\"]]");
    ...
    By ExitDepartment = By.xpath("//button[.//@class=\"p-multiselect-close-icon pi pi-times\"]");
